...
namespace ToolBuddy.PrintableAR
{
    ...
    public ARRaycastManager arRaycastManager;
        ...
        private Quaternion preDragRotation;
        private Vector3 prePinchScale;
    ...
    public float tapMoveThreshold = 15.0f;
        ...
        [CanBeNull]
    private object transitionTriggeringFinger;
        ...
        private void SetupStateMachine()
    {
        ...
        _stateMachine.Configure(State.Pinching)
            .OnEntry(() => prePinchScale = transform.localScale)
            .PermitIf(
                Trigger.FingerUp,
                State.Idle,
                () => Touch.activeFingers.Count == 0
        ...
        _stateMachine.OnTransitioned(
            t =>
            {
                transitionTriggeringFinger = t.Parameters.Length > 0
                    ? t.Parameters[0]
                    : null;
        ...
        private void Update()
    {
        switch (_stateMachine.State)
        {
            case State.Placing:
                Assert.IsTrue(
                    transitionTriggeringFinger != null,
                    nameof(transitionTriggeringFinger) + " != null"
                );

                bool placementSucceeded = TryPlaceObjectAt((transitionTriggeringFinger as Finger).screenPosition);

                preDragRotation = transform.rotation;
        ...
        Vector2 screenPoint)
    {
        ...
        PlaceObjectAtHit(transform, hits[0].pose);
        ...
        private void UpdateDragging()
    {
        ...
        transform.rotation = preDragRotation * yawRotation * pitchRotation;
    }
        ...
        private void UpdatePinching()
    {
        ...
        transform.localScale = prePinchScale * (currentPinchDistance / initialPinchDistance) * scaleSensitivity;
    }
