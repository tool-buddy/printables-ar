...
namespace ToolBuddy.PrintablesAR.ARInteraction
{
    public partial class ARInteractable
    {
        ...
        private class TouchTransitionState
        {
            ...
            /// <summary>
            /// Sets the touch transition state.
            /// </summary>
            /// <param name="firstPressedFinger">The first finger pressed at the moment of the transition.</param>
            /// <param name="secondPressedFinger">The second finger pressed at the moment of the transition.</param>
            /// <param name="transitionTriggeringFingerPosition">The position of the finger that triggered the transition. This can be a finger that is not pressed, for example when there is a transition due to a finger up event.</param>
            public void Set(
